            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="jml_siswa" id="jml_siswa" value="{{ $laporan->jml_siswa }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="jenis_training" id="jenis_training"
                            value="{{ $laporan->jenis_training }}" maxlength="20" class='form-control'>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="jml_peserta" id="jml_peserta" value="{{ $laporan->jml_peserta }}"
                            maxlength="20" class='form-control'>
                        @error('jml_peserta')
                            <p class="text-warning small">{{ $message }}</p>
                        @enderror
                ...
                <div class="col-lg-6 col-md-6 col">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="serapan_industri" id="serapan_industri"
                            value="{{ $laporan->serapan_industri }}" class='form-control'>
